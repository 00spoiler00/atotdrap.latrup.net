<template>
    ...
    <!-- <div>
        ...
        <div
            ...
            class="h-5 w-24 font-bold rounded-xl border-1 pt-0 bg-red-800 border-red-800 text-center py-1">
            Bronze
        </div>
        <div
            v-else-if="license === 'Silver'"
            class="h-5 w-24 font-bold rounded-xl border-1 pt-0 border-gray-400 bg-gray-400 text-center py-1 text-black">
            Silver
        </div>
        <div
            v-else-if="license === 'Platinum'"
            class="h-5 w-24 font-bold rounded-xl border-1 pt-0 border-white bg-white text-center py-1 text-black">
            Platinum
        </div>
        <div
